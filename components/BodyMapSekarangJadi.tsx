    ...
    <div className="w-full h-full flex items-center justify-center bg-slate-900 rounded-lg relative">
        <svg viewBox="0 0 300 400" className="w-full h-full max-h-[500px]" preserveAspectRatio="xMidYMid meet">
            ...
            <g transform="translate(0, 0)">
                <text x="75" y="20" textAnchor="middle" fill="#475569" fontSize="10" fontWeight="bold">ANTERIOR</text>
                {/* Silhouette - Abstract */}
                ...
                {/* Head */}
                <circle cx="75" cy="40" r="12" fill="#1e293b" stroke="#334155" strokeWidth="2" />
            </g>

            {/* --- BACK BODY --- */}
            <g transform="translate(150, 0)">
                <text x="75" y="20" textAnchor="middle" fill="#475569" fontSize="10" fontWeight="bold">POSTERIOR</text>
                {/* Silhouette - Abstract */}
                <path d="M75,30 C90,30 95,45 95,55 L115,60 L125,180 L130,190 L110,380 L95,390 L85,300 L75,280 L65,300 L55,390 L40,380 L20,190 L25,180 L35,60 L55,55 C55,45 60,30 75,30 Z" 
                      fill="#1e293b" stroke="#334155" strokeWidth="2" />
                {/* Head */}
                <circle cx="75" cy="40" r="12" fill="#1e293b" stroke="#334155" strokeWidth="2" />
                {/* Spine Line */}
                <line x1="75" y1="55" x2="75" y2="200" stroke="#334155" strokeWidth="1" strokeDasharray="4 2" />
            </g>
            ...
            {activePoints.length === 0 && (
                 <text x="150" y="200" textAnchor="middle" fill="#64748b" fontSize="12">
