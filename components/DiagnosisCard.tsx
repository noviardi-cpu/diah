    ...
    <div className="mt-6 space-y-4 animate-fade-in print:text-black">
      ...
      <div ref={cardRef} className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl relative overflow-hidden print:bg-white print:border-slate-300">
        ...
        {(diagnosis.treatment_principle && diagnosis.treatment_principle.length > 0) && (
           <div className="mb-8 bg-slate-800/50 border border-slate-700/50 rounded-2xl p-4 flex items-start gap-4">
              ...
              <div>
                 <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Prinsip Terapi (Treatment Principle)</h4>
                          ...
                          <tr key={i} className="hover:bg-slate-900/50 transition-colors">
                             ...
                             <td className="px-4 py-3">
                                <div className="flex justify-between items-center gap-2">
                                   <span className="text-slate-200 italic">{item.value}</span>
              ...
              <div className="bg-emerald-950/20 border border-emerald-500/20 p-5 rounded-2xl flex items-center justify-between group">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-lg font-black text-white print:text-black leading-none uppercase tracking-tighter">
