      ...
      <aside className="w-full md:w-[400px] flex flex-col border-r border-pink-400 bg-pink-900/20">
         <div className="p-6 border-b border-pink-400">
            ...
            <div className="flex gap-2 mb-6 overflow-x-auto scrollbar-hide pb-2">
               ...
               <QuadrantHeader id="OTHER_DEF" label="Qi/Blood Def" icon={Leaf} color="text-emerald-400 bg-emerald-500/10" />
               <QuadrantHeader id="OTHER_EXCESS" label="Stagnation" icon={Wind} color="text-purple-400 bg-purple-500/10" />
            </div>
                ...
                <div className="space-y-8">
                   ...
                   <section className="bg-emerald-950/10 p-8 rounded-3xl border border-emerald-500/20 shadow-xl relative overflow-hidden">
                      ...
                      {selected.key_symptoms && selected.key_symptoms.length > 0 && (
                        <div className="mb-4">
                          <span className="text-[10px] font-black text-emerald-600/70 uppercase mb-2 block">Key Symptoms</span>
                          <ul className="space-y-1">
                            {selected.key_symptoms.map((ks, i) => (
                              <li key={i} className="text-sm text-emerald-100/80 flex items-start gap-2">
                                <span className="text-emerald-500 mt-1">•</span> {ks}
                              </li>
                            ))}
                          </ul>
                        </div>
                      ...
                      {selected.diagnostic_tip && (
                        <div className="mb-4">
                          <span className="text-[10px] font-black text-emerald-600/70 uppercase mb-2 block">Diagnostic Tip</span>
                      ...
                      {selected.needling_method && (
                        <div>
                          <span className="text-[10px] font-black text-emerald-600/70 uppercase mb-2 block">Needling Method</span>
                      ...
                      {(!selected.key_symptoms?.length && !selected.diagnostic_tip && !selected.needling_method) && (
                        <p className="text-sm text-emerald-100/50 italic">
